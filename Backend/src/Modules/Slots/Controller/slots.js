...
const addSlots = (req,res,next)=>{
    ...
    client.query(query,(err,result)=>{
        ...
        let key = 1
        // auto increment id
        const query1 = `SELECT * from slots`
...
console.log({slotid,date,hours,doctorId})
        ...
        const query2 = `INSERT INTO slots(id,date,hour,doctorId,doctorName,fulldate,key) VALUES(${slotid},'${date}','${hours}',${doctorId},'${result.rows[0].name}','${fulldate}',${key})`
