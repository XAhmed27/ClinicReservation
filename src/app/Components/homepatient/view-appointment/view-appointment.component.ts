...
export class ViewAppointmentComponent {
  ...
  saveEditedAppointment() {
    ...
    //   let index = this.userAppointments?.findIndex(app => app.id === this.selectedAppointment?.id);
    //   if (index !== -1) {
    //     if (index != null) {
    //       this.userAppointments?.splice(index, 1, this?.selectedAppointment);
    //     }
    //     this.selectedAppointment = null; // Clear the selected appointment after editing
    //   }
    // }
  }
}
